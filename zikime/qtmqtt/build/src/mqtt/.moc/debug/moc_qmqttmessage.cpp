...
void QMqttMessage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        auto *_t = reinterpret_cast<QMqttMessage *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QMqttMessage::staticMetaObject = { {
    nullptr,
    qt_meta_stringdata_QMqttMessage.data,
    qt_meta_data_QMqttMessage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
